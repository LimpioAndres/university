...
public class Employee extends Person implements IAttend {
	...
	private int idEmployee; //{8080, 7575, 2727};
	private String typeEmployee; //{"Full-time", "Part-time"};
	private String areaWorker; // {"Administration and Accounting", "Worker", "classes.Proffesor", "Security", "IT", "Control Studies", "Human Resources"};
