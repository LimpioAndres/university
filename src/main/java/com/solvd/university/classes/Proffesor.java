...
public class Proffesor extends Employee implements ITeach {
	...
	Proffesor(int idProffesor, int idEmployee, TypeEmployee typeEmployee, AreaWork areaWorker, SubAreaWork subareaWorker,
		...
		setIdProffesor((RandomGenerate.generateNumberRandom(80000, 100000)));
